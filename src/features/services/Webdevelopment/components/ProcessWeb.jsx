...
const steps = [
  {
    id: "01",
    title: "Discover & Plan",
    description: "Define project goals, technical requirements, and user needs for your web application.",
    color: "from-pink-500 to-purple-500"
  },
  {
    id: "02",
    title: "Design & Prototype",
    description: "Create wireframes, UI/UX designs, and interactive prototypes for seamless web experiences.",
    color: "from-blue-500 to-cyan-500"
  },
  {
    id: "03",
    title: "Develop & Test",
    description: "Implement scalable frontend and backend solutions with performance and accessibility in mind.",
    color: "from-gray-400 to-gray-600"
  },
  {
    id: "04",
    title: "Launch & Optimize",
    description: "Deploy, monitor, and continuously improve your web application based on user data and analytics.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <h2 className="text-4xl md:text-4xl font-medium mt-4 mb-6 text-blue-400">
            A process built for modern web applications
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl">
            Streamlined web development focused on responsiveness, performance, and user-centric design.
          </p>
        </div>
